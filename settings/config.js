module.exports = {
  TOKEN:
    process.env.TOKEN ||
    "OTcxMjkzNTUzNTAwMjUwMTUy.GNVzpg.bVjmXkHG33Qd2OyljI-HedvcePNqgZrMXK49IY",
  PREFIX: process.env.PREFIX || "nc!",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded By Anubis`ID | Nusantara Code",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/Nuscode`,
    VoteURL: process.env.VoteURL || `https://discord.gg/Nuscode`,
  },
  options: {
    embedFooter: false,
    nowplayingMsg: true
